...
urlpatterns = [
    ...
    path('api/riyadh-road/<int:road_id>/', views.get_riyadh_road_details, name='get_riyadh_road_details'),
    ...
    path('api/riyadh-roads/deleted/', views.get_deleted_riyadh_roads, name='get_deleted_riyadh_roads'),
]
